...
class MQTTMotionSensorDeviceClassificationFactory
    : public MQTTDeviceClassificationFactory {
  public:
...
class MQTTMotionSensor : public MQTTSensor {
  ...
  public:
    MQTTMotionSensor(MQTTDeviceInfo deviceInfo, String sensorUniqueId,
                     int motionSensorPin, int motionDetectionIterations = 10,
...
class MQTTBatterySensorDeviceClassificationFactory
    : public MQTTDeviceClassificationFactory {
  public:
...
class MQTTDHTSensor : public MQTTSensor {
  ...
  public:
    MQTTDHTSensor(MQTTDeviceClassificationFactory *deviceClassFactory,
                  MQTTDeviceInfo deviceInfo, DHT *dhtSensor,
...
class MQTTTemperatureSensorDeviceClassificationFactory
    : public MQTTDeviceClassificationFactory {
  public:
...
class MQTTHumiditySensorDeviceClassificationFactory
    : public MQTTDeviceClassificationFactory {
  public:
...
class MQTTTemperatureSensor : public MQTTDHTSensor {
  ...
  public:
    MQTTTemperatureSensor(MQTTDeviceInfo deviceInfo, DHT *dhtSensor,
                          String sensorUniqueId, int resetValuesIterations = 5000);
    DynamicJsonDocument
    extendAutoDiscoveryInfo(DynamicJsonDocument autoConfigureJsonDocument);
    void publishMeasurement();
    void reset();
